...
const AppointmentForm = memo(() => {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md text-center">
      <h3 className="text-xl font-semibold mb-6 text-eduhus-accent font-heading">Umów wizytę</h3>

      <Button
        className="bg-eduhus-accent hover:opacity-90 text-white px-8 py-6 text-lg font-medium transition-all hover:scale-105"
