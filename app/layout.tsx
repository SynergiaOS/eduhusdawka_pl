  ...
  return (
    <html lang="pl" suppressHydrationWarning>
      ...
      <body suppressHydrationWarning>
        ...
        <a
          href="#main-content"
          className="skip-link sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 bg-eduhus-accent text-white px-4 py-2 rounded-md z-50"
        >
