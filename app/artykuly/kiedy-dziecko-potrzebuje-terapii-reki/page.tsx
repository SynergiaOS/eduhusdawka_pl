...
export default function KiedyDzieckoTerapiaRekiPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-eduhus-secondary">
      <Header />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <div className="inline-flex items-center gap-2 bg-eduhus-bg-light px-4 py-2 rounded-full mb-6">
                <Hand className="w-5 h-5 text-eduhus-secondary" />
                <span className="text-eduhus-secondary font-medium">Terapia ręki</span>
              </div>
              
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
                Kiedy dziecko potrzebuje <span className="text-eduhus-secondary">terapii ręki?</span>
              </h1>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
              ...
              <div className="mb-12">
                ...
                <div className="space-y-6">
                  <div className="border-l-4 border-purple-500 pl-6 py-4">
                    <h3 className="text-xl font-semibold text-eduhus-secondary mb-2">3-4 lata</h3>
              ...
              <div className="bg-eduhus-bg-light rounded-xl p-8 text-center">
                <h3 className="text-2xl font-bold text-eduhus-secondary mb-4">
                  Masz wątpliwości co do rozwoju motoryki Twojego dziecka?
                </h3>
                <p className="text-eduhus-secondary mb-6 max-w-2xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  ...
                  <Link href="/uslugi/terapia-reki">
                    <button className="bg-white text-eduhus-secondary border-2 border-purple-600 hover:bg-eduhus-bg-light px-8 py-4 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-2">
