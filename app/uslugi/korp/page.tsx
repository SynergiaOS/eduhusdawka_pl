        ...
        <AnimatedSection className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-eduhus-bg-light px-4 py-2 rounded-full mb-6">
              <Target className="w-5 h-5 text-eduhus-icon-adhd 600" />
              <span className="text-eduhus-icon-adhd 700 font-medium">Diagnostyka KORP</span>
            </div>
            
            <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-6 leading-tight">
              <span className="text-eduhus-icon-adhd 600">KORP</span> - Karty Oceny Rozwoju Psychoruchowego
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="tel:+48531509008">
                <button className="bg-eduhus-icon-adhd hover:bg-eduhus-icon-adhd text-white px-8 py-4 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl">
                  📞 Umów badanie: 531 509 008
                </button>
              </a>
              <Link href="/rezerwacja">
                <button className="bg-white text-eduhus-icon-adhd 600 border-2 border-eduhus-icon-adhd 600 hover:bg-eduhus-bg-light px-8 py-4 rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-2">
                  Rezerwacja online
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-6 h-6 text-eduhus-icon-adhd 500 mt-1 flex-shrink-0" />
                    <div>
                      <h3 className="font-semibold text-gray-900">Wczesne wykrycie trudności</h3>
                      <p className="text-gray-900">Szybka interwencja to większa szansa na skuteczne wsparcie</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">Diagnoza uzupełniona szczegółowym wywiadem z opiekunem</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">Rzetelna ocena rozwoju już w okresie niemowlęcym</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <AnimatedSection className="py-16 px-4" delay={300}>
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-xl shadow-lg border border-eduhus-icon-adhd 100">
                <div className="w-12 h-12 bg-eduhus-bg-light rounded-lg flex items-center justify-center mb-4">
                  <Zap className="w-6 h-6 text-eduhus-icon-adhd 600" />
                </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg border border-eduhus-icon-adhd 100">
                <div className="w-12 h-12 bg-eduhus-bg-light rounded-lg flex items-center justify-center mb-4">
                  <Target className="w-6 h-6 text-eduhus-icon-adhd 600" />
                </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg border border-eduhus-icon-adhd 100">
                <div className="w-12 h-12 bg-eduhus-bg-light rounded-lg flex items-center justify-center mb-4">
                  <Eye className="w-6 h-6 text-eduhus-icon-adhd 600" />
                </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg border border-eduhus-icon-adhd 100">
                <div className="w-12 h-12 bg-eduhus-bg-light rounded-lg flex items-center justify-center mb-4">
                  <MessageCircle className="w-6 h-6 text-eduhus-icon-adhd 600" />
                </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg border border-eduhus-icon-adhd 100">
                <div className="w-12 h-12 bg-eduhus-bg-light rounded-lg flex items-center justify-center mb-4">
                  <Heart className="w-6 h-6 text-eduhus-icon-adhd 600" />
                </div>
              ...
              <div className="bg-white p-6 rounded-xl shadow-lg border border-eduhus-icon-adhd 100">
                <div className="w-12 h-12 bg-eduhus-bg-light rounded-lg flex items-center justify-center mb-4">
                  <Brain className="w-6 h-6 text-eduhus-icon-adhd 600" />
                </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="text-center">
                <div className="w-16 h-16 bg-eduhus-bg-light rounded-full flex items-center justify-center mx-auto mb-4">
                  <User className="w-8 h-8 text-eduhus-icon-adhd 600" />
                </div>
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-eduhus-bg-light rounded-full flex items-center justify-center mx-auto mb-4">
                  <Target className="w-8 h-8 text-eduhus-icon-adhd 600" />
                </div>
              ...
              <div className="text-center">
                <div className="w-16 h-16 bg-eduhus-bg-light rounded-full flex items-center justify-center mx-auto mb-4">
                  <BookOpen className="w-8 h-8 text-eduhus-icon-adhd 600" />
                </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-eduhus-bg-light p-8 rounded-2xl">
                <h3 className="text-xl font-semibold text-eduhus-icon-adhd 700 mb-4">Wiek dziecka</h3>
                <p className="text-gray-900 mb-4">
                  Badanie KORP jest przeznaczone dla dzieci w wieku:
                </p>
                <div className="text-2xl font-bold text-eduhus-icon-adhd 600">
                  1 miesiąc życia - 9 lat i 11 miesięcy
                </div>
              </div>
              
              <div className="bg-eduhus-bg-light p-8 rounded-2xl">
                <h3 className="text-xl font-semibold text-eduhus-icon-adhd 700 mb-4">Wskazania</h3>
                <ul className="text-left space-y-2 text-gray-900">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-eduhus-icon-adhd 500 mt-0.5 flex-shrink-0" />
        ...
        <AnimatedSection className="py-16 px-4 bg-white" delay={600}>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-eduhus-bg-light p-8 rounded-2xl max-w-md mx-auto">
              <h3 className="text-2xl font-semibold mb-6 text-eduhus-icon-adhd 700">KORP - Badanie rozwoju</h3>
              <div className="space-y-4">
                <div className="flex justify-between items-center py-2 border-b border-eduhus-icon-adhd 200">
                  <span className="text-gray-900">Badanie + szczegółowa opinia</span>
                  <span className="text-3xl font-bold text-eduhus-icon-adhd 600">350 zł</span>
                </div>
                <div className="flex justify-between items-center py-2">
                  <span className="text-gray-900">Czas trwania</span>
                  <span className="text-lg font-semibold text-eduhus-icon-adhd 600">ok. 120 min</span>
                </div>
              </div>
              <div className="mt-6 text-center">
                <p className="text-sm text-eduhus-icon-adhd 600 mb-4">
                  💡 Kompleksowa ocena wszystkich sfer rozwoju
                </p>
                <a href="tel:+48531509008" className="inline-block">
                  <button className="bg-eduhus-icon-adhd hover:bg-eduhus-icon-adhd text-white px-6 py-3 rounded-lg font-semibold transition-colors">
                    📞 Zadzwoń: 531 509 008
                  </button>
                </a>
              </div>
