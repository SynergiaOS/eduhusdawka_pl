...
export const metadata: Metadata = {
  ...
  keywords: "Forbrain, trening słuchowy, terapia mowy, percepcja głosu, rozwój mowy, czytanie, koncentracja, integracja sensoryczna, 150 zł, 180 zł, Pomigacze, logopedia",
}
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  Forbrain to urządzenie poddane ocenie klinicznej, przeznaczone dla terapeutów i rodziców 
                  pracujących z osobami starającymi się przezwyciężyć trudności w uczeniu się, 
                  przetwarzaniu słuchowym, komunikacji, uwadze lub zapamiętywaniu.
                </p>
